...
import { vectorPaneKind } from "./kinds/vectorKind";
...
// no picker entries), markdown, rss, viewer×3, vector, matching the
// original hand-written TAB_KIND_OPTIONS order for the pre-existing
// kinds exactly.
