...
import openclaudeUrl from "../../../shared/agent-icons/openclaude.png?url";
import opencodeUrl from "../../../shared/agent-icons/opencode.png?url";
import copilotUrl from "../../../shared/agent-icons/copilot.png?url";
import droidUrl from "../../../shared/agent-icons/droid.png?url";

// Ported from ref-proj/orca agent-favicon-assets.ts — bundle favicons at build time.
