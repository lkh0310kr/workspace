# Japanese Dictionary Data — Attribution

This application can import third-party Japanese language data. When you build a dictionary database with `npm run japanese:import`, the following sources may be included.
...
- **Source:** [KANJIDIC2](https://www.edrdg.org/wiki/index.php?title=KANJIDIC_Project)
- **Copyright:** The Electronic Dictionary Research and Development Group
- **Licence:** Creative Commons Attribution-ShareAlike 4.0 International (CC BY-SA 4.0)
...
- **Source:** [한국어기초사전](https://krdict.korean.go.kr/)
- **Provider:** National Institute of Korean Language

## Tatoeba

- **Source:** [Tatoeba](https://tatoeba.org/)
- **Licence:** CC BY 2.0 FR (sentences); check per-file licence on download

## Kanjium (optional pitch accent data)
