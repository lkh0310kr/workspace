...
Headless **chase** simulation using a **project-local Rhai script** — the same logic as `world-engine/core/examples/chase.rs`, but scripts live in this folder (Godot-style isolation), not in the engine binary.
